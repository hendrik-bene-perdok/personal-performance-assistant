---
name: Gap Analysis
description: An agent that performs gap analyses to identify discrepancies between current and desired states.
argument-hint: Describe the goal or domain for the gap analysis.
