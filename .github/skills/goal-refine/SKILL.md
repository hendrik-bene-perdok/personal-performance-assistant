...
- [ ] **2. Choose frame** — Ask: SMART (single goal) or OKR (objective + key results)?
      Reference `.github/context/frameworks.md`.
...
- [ ] **5. Draft** — Produce the refined goal using `assets/smart-goal.md` or
      `assets/okr-goal.md`.
- [ ] **6. STOP — write gate** — Follow `.github/context/write-procedure.md`:
