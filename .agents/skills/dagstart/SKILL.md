...
1. **Context Laden**: Scan `workspace/doelen.md` en `workspace/profiel.md`.
2. **Socratische Q&A (3 Pijlers)**:
   ...
   - **Pijler 3 (Risico-overleggen & O-S-A Priming)**: Identificeer 1-2 momenten met risico op controledrang, oplossingsdrang of mentaal uitchecken. Activeer het luister-anker of de pauzezin.
...
## Steps
- [ ] **1. Context laden**: Lees `doelen.md` (Top 3, Avoid-list, O-S-A priming).
- [ ] **2. Reflectieve Q&A**: Stel de 3 Socratische vragen achtereenvolgens of geclusterd.
